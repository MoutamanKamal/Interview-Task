...
function Curtains(t) {
  var e;
  (this.planes = [], this.shaderPasses = [], this._drawStack = [], this._drawingEnabled = !0, this._forceRender = !1, "string" == typeof t) && (console.warn("Since v4.0 you should use an object to pass your container and other parameters. Please refer to the docs: https://www.curtainsjs.com/documentation.html"), t = {
    container: e = t
  });
...
Curtains.prototype._init = function () {
  ...
  var i = this;
  setTimeout(function () {
    i._onScrollCallback && i._onScrollCallback();
  }, 0);
  ...
  this._scrollManager.yOffset = e, this._scrollManager.lastYDelta = r - this._scrollManager.yOffset;
  ...
  return i._isProgramValid ? this.planes.push(i) : i = !1, i;
  ...
  for (var e, i = this._drawStack, r = 0; r < i.length; r++) t.index === i[r] && this._drawStack.splice(r, 1);

  for (r = 0; r < this.planes.length; r++) t.index === this.planes[r].index && (e = r);
...
}, Curtains.prototype._createShaderPass = function (t) {
  ...
  for (var i = 0; i < this.shaderPasses.length; i++) t.index === this.shaderPasses[i].index && (e = i);
  ...
  var i = [],
      ...
      y = e[2],
      b = e[3];
  return i[0] = v * r + C * o + y * d + b * f, i[1] = v * a + C * h + y * c + b * g, i[2] = v * s + C * l + y * p + b * m, i[3] = v * n + C * u + y * _ + b * x, v = e[4], C = e[5], y = e[6], b = e[7], i[4] = v * r + C * o + y * d + b * f, i[5] = v * a + C * h + y * c + b * g, i[6] = v * s + C * l + y * p + b * m, i[7] = v * n + C * u + y * _ + b * x, v = e[8], C = e[9], y = e[10], b = e[11], i[8] = v * r + C * o + y * d + b * f, i[9] = v * a + C * h + y * c + b * g, i[10] = v * s + C * l + y * p + b * m, i[11] = v * n + C * u + y * _ + b * x, v = e[12], C = e[13], y = e[14], b = e[15], i[12] = v * r + C * o + y * d + b * f, i[13] = v * a + C * h + y * c + b * g, i[14] = v * s + C * l + y * p + b * m, i[15] = v * n + C * u + y * _ + b * x, i;
}, Curtains.prototype._scaleMatrix = function (t, e, i, r) {
  var a = new Float32Array(16);
  return a[0] = e * t[0], a[1] = e * t[1], a[2] = e * t[2], a[3] = e * t[3], a[4] = i * t[4], a[5] = i * t[5], a[6] = i * t[6], a[7] = i * t[7], a[8] = r * t[8], a[9] = r * t[9], a[10] = r * t[10], a[11] = r * t[11], t !== a && (a[12] = t[12], a[13] = t[13], a[14] = t[14], a[15] = t[15]), a;
}, Curtains.prototype._applyTransformationsMatrix = function (t, e, i) {
  var r = new Float32Array(16),
      ...
      c = Math.sin(o),
      p = Math.cos(o);
  a[0] = h * d * p - l * u * c, a[1] = l * u * p + h * d * c, a[2] = l * d * c - h * u * p, a[3] = l * d * p + h * u * c;
  var _ = a[0],
      f = a[1],
      g = a[2],
      m = a[3],
      ...
      D = i[1],
      A = i[2];
  return r[0] = (1 - (R + T)) * B, r[1] = (b + M) * B, r[2] = (w - S) * B, r[3] = 0, r[4] = (b - M) * D, r[5] = (1 - (y + T)) * D, r[6] = (P + E) * D, r[7] = 0, r[8] = (w + S) * A, r[9] = (P - E) * A, r[10] = (1 - (y + R)) * A, r[11] = 0, r[12] = t[0], r[13] = t[1], r[14] = t[2], r[15] = 1, r;
}, Curtains.prototype._applyMatrixToPoint = function (t, e) {
  var i = t[0],
      r = t[1],
      a = t[2],
      s = 1 / (e[3] * i + e[7] * r + e[11] * a + e[15]);
  return t[0] = (e[0] * i + e[4] * r + e[8] * a + e[12]) * s, t[1] = (e[1] * i + e[5] * r + e[9] * a + e[13]) * s, t[2] = (e[2] * i + e[6] * r + e[10] * a + e[14]) * s, t;
  ...
  if (this._drawingEnabled || this._forceRender) {
    ...
    if (this.shaderPasses.length > 0) for (t = 0; t < this.shaderPasses.length; t++) {
      this.shaderPasses[t]._drawPlane();
    }
  }
  ...
  this._type = "BasicPlane", this._wrapper = t, this.htmlElement = e, this._initBasePlane(e, i);
}, Curtains.BasePlane.prototype._initBasePlane = function (t, e) {
  ...
  var r = this;
  return e.uniforms && Object.keys(e.uniforms).map(function (t, i) {
    var a = e.uniforms[t];
    r.uniforms[t] = {
      name: a.name,
      type: a.type,
  ...
  }), i ? (this._shouldDraw = !0, this._setAttributes(), this._setDocumentSizes(), this._setUniforms(this.uniforms), this._initializeBuffers(), this._canDraw = !0, this) : i;
}, Curtains.BasePlane.prototype._setDefaultVS = function (t) {
...
}, Curtains.BasePlane.prototype._setDefaultFS = function (t) {
  ...
  if (e) {
    for (var i = [t._applyMatrixToPoint([-1, 1, 0], e), t._applyMatrixToPoint([1, 1, 0], e), t._applyMatrixToPoint([1, -1, 0], e), t._applyMatrixToPoint([-1, -1, 0], e)], r = 1e6, a = -1e6, s = 1e6, n = -1e6, o = 0; o < i.length; o++) {
      var h = i[o];
      h[0] = (h[0] + 1) / 2, h[1] = 1 - (h[1] + 1) / 2, h[0] < r ? r = h[0] : h[0] > a && (a = h[0]), h[1] < s ? s = h[1] : h[1] > n && (n = h[1]);
    }

    return {
      width: (a - r) * t._boundingRect.width,
      height: (n - s) * t._boundingRect.height,
      top: s * t._boundingRect.height + t._boundingRect.top,
      left: r * t._boundingRect.width + t._boundingRect.left,
      right: r * t._boundingRect.width + t._boundingRect.left + (a - r) * t._boundingRect.width,
      bottom: s * t._boundingRect.height + t._boundingRect.top + (n - s) * t._boundingRect.height
    };
  }
...
}, Curtains.BasePlane.prototype.createTexture = function (t, e) {
  ...
  i._onSourceLoadedHandler = i._onSourceLoaded.bind(i, e), e.addEventListener("load", i._onSourceLoadedHandler, !1), e.complete && i._onSourceLoaded(e), this.images.push(e);
  ...
  var i = this.createTexture(e.sampler);
  i._onSourceLoadedHandler = i._onVideoLoadedData.bind(i, e), e.addEventListener("canplaythrough", i._onSourceLoadedHandler, !1), e.readyState >= e.HAVE_FUTURE_DATA && i._onSourceLoaded(e), e.load(), this.videos.push(e);
  ...
  for (var t = 0; t < this.textures.length; t++) {
    ...
    if ("video" === e.type) {
      ...
      void 0 !== i && i.catch(function (t) {
        r._wrapper.productionMode || console.warn("Could not play the video : ", t);
      });
    }
  }
  ...
  var i = this.scale ? this.scale : {
    ...
    y: 1
      ...
      r = (this._boundingRect.document.width - this._boundingRect.document.width * i.x) / 2,
      a = (this._boundingRect.document.height - this._boundingRect.document.height * i.y) / 2,
      s = this._boundingRect.document.width * i.x / this._wrapper.pixelRatio,
      n = this._boundingRect.document.height * i.y / this._wrapper.pixelRatio,
      o = (this._boundingRect.document.top + a) / this._wrapper.pixelRatio;
  return {
    x: (t - (this._boundingRect.document.left + r) / this._wrapper.pixelRatio) / s * 2 - 1,
    y: 1 - (e - o) / n * 2
  };
  ...
  Curtains.BasePlane.call(this, t, e, i), this.index = this._wrapper.planes.length, this._type = "Plane", this._canDraw = !1, i || (i = {}), this._setInitParams(i), this._isProgramValid ? (this._initPositions(), this._initSources()) : this._wrapper._onErrorCallback && this._wrapper._onErrorCallback();
  ...
  t.drawCheckMargins && (i = t.drawCheckMargins), this.drawCheckMargins = i, this.rotation = {
    x: 0,
    y: 0,
    z: 0
  ...
  if (this.autoloadSources) {
    ...
    for (e = 0; e < this.htmlElement.getElementsByTagName("canvas").length; e++) r.push(this.htmlElement.getElementsByTagName("canvas")[e]);

    r.length > 0 && this.loadSources(r), this._loadingManager.initSourcesToLoad = t.length + i.length + r.length;
  }
  ...
  a = setInterval(function () {
    s._loadingManager.sourcesLoaded >= s._loadingManager.initSourcesToLoad && (clearInterval(a), s._onReadyCallback && s._onReadyCallback());
  ...
  var r = this._wrapper._boundingRect.width / this._wrapper._boundingRect.height;
  return t !== this._fov && (this._fov = t), [t / r, 0, 0, 0, 0, t, 0, 0, 0, 0, (e + i) * (1 / (e - i)), -1, 0, 0, e * i * (1 / (e - i)) * 2, 0];
}, Curtains.Plane.prototype.setPerspective = function (t, e, i) {
  var r;
  (r = null === t || "number" != typeof t ? 75 : parseInt(t)) < 1 ? r = 1 : r > 180 && (r = 180);
  var a = parseFloat(e) || .1,
      s = parseFloat(i) || 100;
  this._matrices && (this._matrices.pMatrix.matrix = this._setPerspectiveMatrix(r, a, s), this._wrapper.glContext.useProgram(this._program), this._wrapper.glContext.uniformMatrix4fv(this._matrices.pMatrix.location, !1, this._matrices.pMatrix.matrix), this._canDraw && this._setMVMatrix());
  ...
  var t = this._wrapper,
    ...
    y: this.scale.y * this._boundingRect.computed.height / 2
      ...
      i = [this._translation.x, this._translation.y, this._translation.z - this._fov / 2],
  ...
  if (t = null === t || "number" != typeof t ? 1 : Math.max(parseFloat(t), .001), e = null === e || "number" != typeof e ? 1 : Math.max(parseFloat(e), .001), t !== this.scale.x || e !== this.scale.y) {
    ...
    for (var i = 0; i < this.textures.length; i++) this.textures[i]._adjustTextureSize();
  }
}, Curtains.Plane.prototype.setRotation = function (t, e, i) {
  t = parseFloat(t) || 0, e = parseFloat(e) || 0, i = parseFloat(i) || 0, t === this.rotation.x && e === this.rotation.y && i === this.rotation.z || (this.rotation = {
    x: t,
    y: e,
    z: i
  }, this._setMVMatrix());
  ...
  e.right < t._boundingRect.left - this.drawCheckMargins.right || e.left > t._boundingRect.left + t._boundingRect.width + this.drawCheckMargins.left || e.bottom < t._boundingRect.top - this.drawCheckMargins.bottom || e.top > t._boundingRect.top + t._boundingRect.height + this.drawCheckMargins.top ? this._shouldDraw && (this._shouldDraw = !1, setTimeout(function () {
    i._onLeaveViewCallback && i._onLeaveViewCallback();
  }, 0)) : (this._shouldDraw || setTimeout(function () {
    i._onReEnterViewCallback && i._onReEnterViewCallback();
  ...
  e || (e = {}), e.widthSegments = 1, e.heightSegments = 1, Curtains.BasePlane.call(this, t, t.container, e), this.index = this._wrapper.shaderPasses.length, this._type = "ShaderPass", this._isProgramValid && this._initShaderPassPlane();
...
}, Curtains.ShaderPass.prototype._setDefaultVS = function (t) {
...
}, Curtains.ShaderPass.prototype._setDefaultFS = function (t) {
  ...
  this._sampler.location = t.getUniformLocation(e._program, i), t.uniform1i(this._sampler.location, this.index);
  ...
  var t = this._plane.scale ? this._plane.scale : {
    ...
    y: 1
      ...
      i = this._plane._boundingRect.document.height * t.y,
      r = this._size.width,
      a = this._size.height,
      s = r / a,
      n = e / i,
      o = 0,
      h = 0;
  return n > s ? h = Math.min(0, i - e * (1 / s)) : n < s && (o = Math.min(0, e - i * s)), {
    planeWidth: e,
    planeHeight: i,
    sourceWidth: r,
    sourceHeight: a,
  ...
  this._textureMatrix.matrix = this._wrapper._scaleMatrix(i, e.x, e.y, 1), this._wrapper.glContext.useProgram(this._plane._program), this._wrapper.glContext.uniformMatrix4fv(this._textureMatrix.location, !1, this._textureMatrix.matrix);
